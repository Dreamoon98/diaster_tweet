...
train['text']=train['text'].apply(lambda x : pre(x,url=1, user=1, number=0, punct=0, stopword = 0))
...
out = sb(input_ids, attention_mask=input_mask)[0]  # (0 is the last hidden states,1 means pooler_output)
...
sample_data.to_csv('submission_remove_all.csv',index = False)